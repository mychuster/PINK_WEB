      ...
      <div>
        ...
        <el-main>
          <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" stripe>
            ...
            <el-table-column prop="e_id" label="编号" width="120"></el-table-column>
            <el-table-column prop="e_name" label="单位名称" width="170"></el-table-column>
            <el-table-column prop="e_address" label="总部地址" width="250"></el-table-column>
            <el-table-column prop="e_type" label="企业类型" width="170"></el-table-column>
            <el-table-column prop="avatarUrl" label="图片" width="150">
